...
// client handler run by the proactor in a new thread per connection
// signature matches proactorFunc: void* (*)(int sockfd)
...
int main() {
    ...
    // stopProactor closes the listener and waits for the proactor thread to exit
